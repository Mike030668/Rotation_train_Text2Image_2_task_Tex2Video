...
## *Изучение применения матриц вращения как для тренировки сеией, так и применения внутри сети, мной только начато*
## *Обучение построено на выучивания сеть разности в кадре как в пиксельном, так и в косинусном пространстве, поэтому требуется переход на датасет более высокогго разрешения.*
## *Далее также стоит усложнить уже саму сеть и добавить слои вращения и кросс_внимания*
